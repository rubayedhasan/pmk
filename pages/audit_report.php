...
<body>
    ...
    <main>
        ...
        <section id="report-hero">
            <div class="container-width">
                ...
                <p class="report-hero-text">
                    Explore PMK’s audit reports, highlighting financial transparency, accountability, and key performance insights.
                </p>
            </div>
        </section>
        ...
        <section class="report-drawer" id="report-drawer">
            <div class="report-drawer-header">
                <h5 class="report-drawer-header-title">Audit Report</h5>
        ...
        <!-- section:: audit report display area  -->
                ...
                <div class="report-area-container">
                    ...
                    <aside class="report-view-panel">
                        ...
                        <div class="view-panel-header">
                            ...
                            <h4 class="panel-header-title">Audit Report</h4>
                            <p class="panel-header-text">
                                Explore PMK's audit reports and disclosures.
                            </p>
                        </div>
                    ...
                    <div class="report-board">
                        ...
                        <div class="report-frame-board">
                            <!-- report pdf iframe  -->
                            <iframe src="../assets/annual_report/annual_report_2022-23.pdf" id="report-frame" class="no-display" frameborder="0" title="Audit Report PDF" allowfullscreen="" loading="lazy" fetchpriority="high" decoding="async" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            ...
                            <div class="report-board-empty" id="empty-report-board">
                                ...
                                <p class="empty-board-subtitle">
                                    Select a financial year from the list to view that audit report.
                                </p>
    ...
    <script src="../js/audit_report.js"></script>
</body>
