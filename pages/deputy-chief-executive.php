                ...
                <section id="executive-person-overview">
                    ...
                    <aside id="overview-sidebar">
                        ...
                        <ul class="sidebar-social">
                            ...
                            <li>
                                <a href="https://www.facebook.com/PMKNGO" target="_blank" aria-label="facebook" title="Facebook">
                                    <i class="fa-brands fa-facebook"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.linkedin.com/in/palli-mongal-karmosuchi-pmk-599597426/" target="_blank" aria-label="linkedin" title="Linkedin">
                                    <i class="fa-brands fa-square-linkedin"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://x.com/" target="_blank" aria-label="x-twitter" title="X-Twitter">
                                    <i class="fa-brands fa-square-x-twitter"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.youtube.com/@pallimongalkarmosuchipmk9007" target="_blank" aria-label="youtube" title="Youtube">
